...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ja": {
        ...
        "landing.headline": "13の主要指標を、自動で抽出・比較。",
        "landing.sub": "3つの比較モード。すべての数字は抽出元ページまで辿れる。",
    ...
    "en": {
        ...
        "landing.headline": "Auto-extract and compare 13 key metrics.",
        "landing.sub": "Three comparison modes. Every figure traces to its source page.",
    ...
    "zh": {
        ...
        "landing.headline": "自动抽取、比较 13 项核心指标。",
        "landing.sub": "三种比较模式，每个数字都可追溯到原文页。",
